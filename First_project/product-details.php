					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="product-details.php">Product details</a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-8 col-12">
						<div class="product-single-main">
							<div class="row">
								<div class="col-12">
									<div class="image">
										<img src="https://cdn.pixabay.com/photo/2021/02/26/15/52/man-6052253__480.jpg" alt="#">
									</div>
									<br>
									<!-- Add to cart start -->
									...
									<button type="button" class="btn btn-cart" style="width:300px; Margin-left:65px;" >
										<p> Add to cart </p>
									</button>
									<!-- Add to cart end -->
									<div class="blog-detail">
										<h2 class="blog-title">Men's T-shirt</h2>
									</div>
									<div>
										<p> Cotton - 100 % <br>
											Model height - 180 cm <br>
											Product size - M
										</p>
									</div>
								...
								<div class="col-12">
									<div class="comments">
										...
										<div class="single-comment">
											<img src="https://cdn.pixabay.com/photo/2016/09/01/08/24/smiley-1635449__340.png" alt="#">
											<div class="content">
